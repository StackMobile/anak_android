...
public class AKCameraManager {
    ...
    private AspectFrameLayout           mCameraPreviewContainer;
    ...
    public void createCameraView() {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(display.getHeight(), display.getHeight());
        mCameraPreviewContainer.setLayoutParams(params);
        mCameraPreviewContainer.setAspectRatio(0.75);
    ...
    public void setMask(AKMask mask) { //Set mask
        //Should implement function for place mask.
    }
    ...
    public void setCameraPreviewContainer(AspectFrameLayout container) {
        if (container != null) {
