...
public class AKRadioGroup extends LinearLayout {
     ...
     * {@inheritDoc}
     */
    public AKRadioGroup(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public AKRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        attributes.recycle();
                ...
                public void onClick(View v) {
                    for (int i = 0; i < ((ViewGroup)(v)).getChildCount(); i++) {
                        ...
                        if (c instanceof RadioButton) {
                            ...
                            setCheckedId(((RadioButton)c).getId());
                        }
                    }
                }
            });
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new AKRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(AKRadioGroup group, @IdRes int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            traverseTree(child);
            if (parent == AKRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
                // generates an id if it's missing
                if (id == View.NO_ID) {
                    id = View.generateViewId();
