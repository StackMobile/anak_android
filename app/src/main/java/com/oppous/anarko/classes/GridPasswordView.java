...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void inflaterViews(Context context) {
        ...
        mInputView.setTypeface(FontManager.getCustomFont(context, this.getResources().getString(R.string.font_gunplay)));
        ...
        while (index < mPasswordLength) {
            ...
            textView.setTypeface(FontManager.getCustomFont(context, this.getResources().getString(R.string.font_gunplay)));
    ...
    private TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            Typeface typeface = Typeface.createFromAsset(AppManager.getInstance().getContext().getAssets(), "fonts/gunplay.ttf");
            ...
            if (newStr.length() == 1) {
                ...
                for (int i = 0; i < mPasswordArr.length; i++) {
                    if (mPasswordArr[i] == null) {
                        ...
                        mViewArr[i].setTypeface(typeface);
                        notifyTextChanged();
                        break;
                    }
                }
